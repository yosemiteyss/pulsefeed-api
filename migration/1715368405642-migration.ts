...
export class Migration1715368405642 implements MigrationInterface {
  name = 'Migration1715368405642';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "sources" ("createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" character varying NOT NULL, "title" character varying NOT NULL, "link" character varying NOT NULL, "description" character varying, CONSTRAINT "PK_85523beafe5a2a6b90b02096443" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "feeds" ("createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" character varying NOT NULL, "title" character varying NOT NULL, "description" character varying, "link" character varying, "image" character varying, "sourceId" character varying, CONSTRAINT "PK_3dafbf766ecbb1eb2017732153f" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "news" ("createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "id" character varying NOT NULL, "title" character varying NOT NULL, "link" character varying NOT NULL, "source" character varying NOT NULL, "category" "public"."news_category_enum" NOT NULL DEFAULT 'general', "description" character varying, "image" character varying, "publishedAt" TIMESTAMP WITH TIME ZONE NOT NULL, "keywords" text array, CONSTRAINT "PK_39a43dfcb6007180f04aff2357e" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
